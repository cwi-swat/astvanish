...
function initialize(env) {initializeQuestion(env);
...
function eval_(env) {return env[$1.toString()];}
...
function renderQuestion$6(env) {if (eval_(env)) {
                renderQuestion$5(env);
            }}
function render(env) {renderQuestion(env);
...
function computeQuestion$4(env) {var val = eval($4, env);
